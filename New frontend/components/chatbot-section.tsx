...
import { LayoutGrid, Sparkles, FileText, Handshake, Send } from "lucide-react"
...
export function ChatbotSection() {
  ...
  const suggestions = ["What can I ask you to do?", "Find policies related to remote work"]
  ...
  const handleSendMessage = (content: string) => {
    ...
    setTimeout(() => {
      const botMessage: Message = {
        ...
        type: "bot",
        content:
          'Go to the HR Portal and then choose "Leave Requests," select Annual Leave, set your dates, and submit for manager approval.',
        timestamp: new Date(),
      }
